...
local mymenu = {
   { "&Thunar", "thunar", '/usr/share/icons/gnome/32x32/apps/system-file-manager.png' },
...
vicious.register(cpuwidget, vicious.widgets.cpu, '  CPU <span color="#90ee90">$1% </span>', 5)
-- }}}
...
function volumectl (mode, widget)
    if mode == "update" then
        ...
        if not tonumber(volume) then
            widget:set_markup("<span color='red'>ERR_s</span>")
            do return end
        end
...
globalkeys = awful.util.table.join(
    ...
    awful.key({                   }, "Print",
        function ()
            ...
            -- awful.util.spawn("bash -c 'cd ~/tmpfs\nscrot\n'")
    ...
    -- My programs
	-- add by logevery
	-- awful.key({ modkey, "Control" } , "a", function () awful.util.spawn("/opt/anki-2.0/anki") end),
	awful.key({ modkey, "Control" } , "a", function () awful.util.spawn("anki") end),
	awful.key({ modkey, "Control" } , "c", function () awful.util.spawn("chromium --disk-cache-dir=/dev/shm/chromium") end),
	awful.key({ modkey, "Control" } , "d", function () awful.util.spawn("doublecmd") end),
	awful.key({ modkey, "Control" } , "f", function () awful.util.spawn("file-roller") end),
	awful.key({ modkey, "Control" } , "g", function () awful.util.spawn("vmware") end),
	awful.key({ modkey, "Control" } , "p", function () awful.util.spawn("smplayer") end),
	awful.key({ modkey, "Control" } , "q", function () awful.util.spawn("/opt/bin/QIpmsg") end),
	awful.key({ modkey, "Control" } , "s", function () awful.util.spawn("stardict") end),
	...
	awful.key({ modkey,           } , "w", function () awful.util.spawn("WizNote") end),
	awful.key({                   } , 'XF86AudioRaiseVolume', function () awful.util.spawn("amixer set Master 5%+") end),
	awful.key({                   } , 'XF86AudioLowerVolume', function () awful.util.spawn("amixer set Master 5%-") end),
	awful.key({                   } , 'XF86AudioMute', function () awful.util.spawn("amixer set Master toggle") end),
	awful.key({ modkey,           } , "a", function () awful.util.spawn("/home/cnfn/YUNIO/software/deepin-screenshot/src/deepin-screenshot") end),
   -- add by logevery
  ...
  -- All clients will match this rule.
  {
    ...
    rule_any = {
      class = {
		...
		'Doublecmd',
		'Xfce4-screenshooter', 'Anki', 'Ristretto',
		'File-roller', 'Wicd-client.py', 'Thunar',
		'com-mucommander-Launcher', 'Multiget',
		'Xfce4-appfinder', 'Xfce4-taskmanager',
		'Tipswindow.py', 'RescueTime',
		'eclipse', '文件操作进度', 'xterm',
		'deluge',
      },
      name = {
   ...
   -- add by logevery
   { rule = { class = "gedit"                    }, properties = { floating = true, tag = tags[1][1] }  },
   { rule = { class = "Thunar"                   }, properties = { floating = true, tag = tags[1][1] }  },
   { rule = { class = "Chromium"                 }, properties = { floating = true, tag = tags[1][2] }  },
   { rule = { class = "Vmware"                   }, properties = { floating = true, tag = tags[1][3] }  },
   { rule = { class = "Anki"                     }, properties = { floating = true, tag = tags[1][4] }  },
   { rule = { class = "WizNote"                  }, properties = { floating = true, tag = tags[1][4] }  },
   { rule = { class = "Multiget"                 }, properties = { floating = true, tag = tags[1][4] }  },
   { rule = { class = "QIpmsg"                   }, properties = { floating = true, tag = tags[1][4] }  },
   { rule = { class = "VirtualBox"               }, properties = { floating = true, tag = tags[1][4] }  },
   { rule = { class = "gimp"                     }, properties = { floating = true, tag = tags[1][4] }  },
   { rule = { class = "Deluge"                     }, properties = { floating = true, tag = tags[1][4] }  },
   { rule = { class = "firefox"                     }, properties = { floating = true, tag = tags[1][4] }  },
   { rule = { class = "Thunderbird"              }, properties = { floating = true, tag = tags[1][4] }  },
   { rule = { class = "qq"                       }, properties = { floating = true, tag = tags[1][5] }  },
   { rule = { class = "Qq"                       }, properties = { floating = true, tag = tags[1][5] }  },
   { rule = { class = "Smplayer"                 }, properties = { floating = true, tag = tags[1][5] }  }
   -- add by logevery
}
-- }}}
